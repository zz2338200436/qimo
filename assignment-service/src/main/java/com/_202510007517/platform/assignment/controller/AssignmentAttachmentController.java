...
import com._202510007517.platform.assignment.service.AssessmentAttachmentService;
...
@RestController
@RequestMapping("/api/attachments/assignment")
public class AssignmentAttachmentController {

    private final AssessmentAttachmentService attachmentService;

    public AssignmentAttachmentController(AssessmentAttachmentService attachmentService) {
