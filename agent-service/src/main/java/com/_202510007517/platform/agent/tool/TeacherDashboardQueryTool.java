...
@Component
public class TeacherDashboardQueryTool implements AgentTool {

    private final TeacherAnalysisEdgeClient analysisClient;

    public TeacherDashboardQueryTool(TeacherAnalysisEdgeClient analysisClient) {
    ...
    public Map<String, Object> execute(Long userId, String userRole, Map<String, Object> request) {
        ResponseResult<Map<String, Object>> response = analysisClient.getTeacherDashboard(
        ...
        result.put("teacherDashboard", response.getData());
