...
public class AgentAuditService {
    ...
    String targetService(AgentIntent intent) {
        return switch (intent) {
            ...
            case GENERATE_QUESTIONS, QUERY_QUESTION_BANK, QUERY_RAG_KNOWLEDGE, INTERNET_SEARCH, READ_WEB_PAGE,
                    UNKNOWN -> "agent-service";
            case GENERATE_EXAM, GENERATE_LEARNING_SUGGESTIONS -> "ai-service";
            ...
            case QUERY_STUDENT_STATS, QUERY_STUDY_TIME_DISTRIBUTION, QUERY_TEACHER_DASHBOARD,
                    ...
                    QUERY_KNOWLEDGE_MASTERY -> "analysis-service";
        };
    }
}
