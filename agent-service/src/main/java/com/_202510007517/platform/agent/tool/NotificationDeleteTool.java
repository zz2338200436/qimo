...
@Component
public class NotificationDeleteTool implements AgentTool {

    private final NotificationEdgeClient notificationClient;

    public NotificationDeleteTool(NotificationEdgeClient notificationClient) {
    ...
    public Map<String, Object> execute(Long userId, String userRole, Map<String, Object> request) {
        ...
        ResponseResult<Void> response = notificationClient.deleteNotification(String.valueOf(userId), notificationId);
