...
public interface AssessmentAttachmentService {
    ...
    List<AssessmentAttachmentEntity> saveAttachments(Long examId, Long uploadedBy, MultipartFile[] files) throws IOException;
    ...
    List<Map<String, Object>> getAttachmentDtos(Long examId);
    ...
    void deleteAttachments(Long examId);

    static AssessmentAttachmentService none() {
        return new AssessmentAttachmentService() {
            @Override
            public List<AssessmentAttachmentEntity> saveAttachments(Long examId, Long uploadedBy, MultipartFile[] files) {
                return List.of();
            }
